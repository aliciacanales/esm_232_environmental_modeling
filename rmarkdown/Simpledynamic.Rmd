...
dexppop(t=100,P=20, r=0.01) ## little r is the growth rate
...
```{r explicit}
source("../functions/exppop.R") ## analytical calculation of population growth

# gives population after any time given an initial population
## use dexppop on bunnies
dexppop(P = 20, r = 0.01, K = 1000)
...
```{r iterate1}
source("../functions/discrete_logistic_popK.R")
